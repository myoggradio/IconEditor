...
public class FFTLowPass implements Operation
{
	private int n = 0;
	private int m = 0;
	...
	{
		Protokol.write("FFTLowPass:operate:start");
		long start = System.currentTimeMillis();
		double rmin = Parameter.rmin;
		...
		Protokol.write("FFTLowPass:operate:Es dauerte " + sekunden + " Sekunden");
		return erg;
	}
	public void reset()
	{
